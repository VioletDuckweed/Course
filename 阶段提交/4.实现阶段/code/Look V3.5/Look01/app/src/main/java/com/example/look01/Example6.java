...
public class Example6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web_rec.loadUrl("https://dappei.com/photos/70346");
        ...
        new Thread()
        {
            public void run()
            {
                ...
                {
                    // 定义一个URL对象
                    URL url = new URL("https://images.dappei.com/uploads/photo/image/71377/large_32bb4b98104b8bb2.jpg");
                    // 打开该URL对应的资源的输入流
                    ...
                    is = url.openStream();
                    // 打开手机文件对应的输出流
                    OutputStream os = openFileOutput("12.png"
                            , MODE_PRIVATE);
                    ...
                    URL url2=new URL("https://images.dappei.com/uploads/photo/image/70346/large_6bfc5bb8738f54ea.jpg");
                    InputStream is2=url2.openStream();
                    bitmap2=BitmapFactory.decodeStream(is2);
                    handler2.sendEmptyMessage(0x123);
                    is2.close();
                    is2=url2.openStream();
                    OutputStream os2=openFileOutput("13.png",MODE_PRIVATE);
