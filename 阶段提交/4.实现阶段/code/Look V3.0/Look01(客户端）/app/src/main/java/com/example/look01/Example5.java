...
public class Example5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web_rec.loadUrl("https://dappei.com/photos/71477");
        ...
        new Thread()
        {
            public void run()
            {
                ...
                {
                    // 定义一个URL对象
                    URL url = new URL("https://images.dappei.com/uploads/photo/image/66917/large_be5b7e975d17ca8f.jpg");
                    // 打开该URL对应的资源的输入流
                    ...
                    is = url.openStream();
                    // 打开手机文件对应的输出流
                    OutputStream os = openFileOutput("10.png"
                            , MODE_PRIVATE);
                    ...
                    URL url2=new URL("https://images.dappei.com/uploads/photo/image/71477/large_1ff335ee443bea6e.jpg");
                    InputStream is2=url2.openStream();
                    bitmap2=BitmapFactory.decodeStream(is2);
                    handler2.sendEmptyMessage(0x123);
                    is2.close();
                    is2=url2.openStream();
                    OutputStream os2=openFileOutput("11.png",MODE_PRIVATE);
